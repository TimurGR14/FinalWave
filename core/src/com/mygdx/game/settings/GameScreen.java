...
public class GameScreen implements Screen {
    private Main main;
    private int DelayL=20;
    private long StartTimerL;
    public Lives lives;
    ...
    public void collP(){
        for(int i=0;i<Main.enemyWithBows.size;i++){
            if(Main.player.getBounds().Overlaps(Main.enemyWithBows.get(i).boundsEnemyBow)){
                Main.player.HitP();
            }
        }
    }
